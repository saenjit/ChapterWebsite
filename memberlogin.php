...
<head>
  <meta charset="utf-8">
  <title>ΣAE - NJIT | Member Login</title>
          ...
          <div class="slider-content text-center">
            <div class="header-bottom">
              <div class="layer2 wow zoomIn" data-wow-duration="1s" data-wow-delay=".4s">
                <h1 class="title2">Welcome Brothers </h1>
              </div>
              <div class="layer3 wow zoomInUp" data-wow-duration="2s" data-wow-delay="1s">
                <h2 class="title3">Please log in below.</h2>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="post-information">
                  ...
                  <div class="entry-meta">
                    ...
                    <form action = "memberloginhandler.php" method = "post" name=loginForm>
                        <fieldset id="field"><legend>Brothers, please enter the password.</legend>
