...
<html lang="en">
		...
		<title>NJ Iota Tau | Positions | Sigma Alpha Epsilon</title>
	...
	<body>
        ...
        <!--<a class="rushbutton" href="RushCalendarFall2014_fixed.pdf">Download the 2014 Rush Calendar</a>-->
				...
				<img src="images/brotherPage.jpg" class="coverBrother">
			</div>
		</section>
...
<!--End Default Page stuff-->          
			...
			<div class="row">
				...
				<div class="col_8">
                    <div id = positionsTableBackground style="clear:left;">   
                        <img src="/documents/positions.png">
                    </div> 
                </div>
