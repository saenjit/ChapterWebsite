...
<!------------------------------AUTHENTICATION----------------------->
            <?php
                $bad = false;
                $pass = $_GET['truegentlemen'];
                $webmasterPass = 'webpass';
                $memberPass = 'phialpha2018';
                ...
                if ($pass != $memberPass){
                    if ($pass == $webmasterPass){
                        header('Location:webmaster.php?pass='.$pass);
                    }
                    echo "
                        <script>
...
<!--Past this means they authenticated-->
            <script>
                ...
                <div class="row">
                    ...
                    <!--Calendar-->
                        <div>
                            <iframe src="https://calendar.google.com/calendar/embed?mode=WEEK&amp;height=600&amp;wkst=1&amp;bgcolor=%23FFFFFF&amp;src=njit.edu_37tls0s8gjbirgh9asfr6komas%40group.calendar.google.com&amp;color=%23AB8B00&amp;ctz=America%2FNew_York" style="border-width:0" width="600" height="400" frameborder="0" scrolling="no"></iframe>
                        </div>
                    <!--End Calendar-->
