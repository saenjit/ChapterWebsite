...
<html lang="en">
		...
		<title>NJ Iota Tau | Rush | Sigma Alpha Epsilon</title>
	...
	<body>
		<header class="row">
			<nav class="col_12">
				<ul class="horizontal">
					...
					<li><a href="rush.php" class="active">Rush</a></li>
        ...
        <!--<a class="rushbutton" href="RushCalendarFall2014_fixed.pdf">Download the 2014 Rush Calendar</a>-->
				...
				<img src="images/RushCover.png" class="coverRush">
			</div>
		</section>
...
<!--End Default Page stuff-->          
			...
			<div class="row">
				...
				<div class="col_8">
					...
					<p>
						<?php
                            $homepage = file_get_contents("rush.txt");
                            echo $homepage;
                        ?>
					</p>
				</div>
