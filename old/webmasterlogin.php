...
<html lang="en">
		...
		<title>NJ Iota Tau | Webmaster Login | Sigma Alpha Epsilon</title>
	...
	<body>
        ...
        <!--<a class="rushbutton" href="RushCalendarFall2014_fixed.pdf">Download the 2014 Rush Calendar</a>-->
				...
				<img src="images/webmaster.jpg" class="coverWebmasterLogin">
			</div>
		</section>
...
<!--End Default Page stuff-->          
			...
			<div class="row">
				...
				<div class="col_8">
                    ...
                    <form action = "webmasterloginhandler.php" method = "post" name=loginForm>
                        <fieldset id="field"><legend>Enter the WebMaster Login Credentials</legend>
                            
                        Username: <input type = text name = alpha id = alpha placeholder = "Username" required>
                        <br>
                        Password: <input type=password name=truegentlemen id=pass autocomplete="off" placeholder="Password" required>
                        <br>
